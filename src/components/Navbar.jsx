...
const Navbar = () => {
  ...
  return (
    ...
    <Link to="/" className="text-2xl text-white px-2 mx-10">🧑‍💻 DevTinder</Link>
    <div className="relative inline-block" >
      ...
      {isOpen && (
        ...
        >
          <ul className="py-2">
            <Link to="/profile" className="px-4 py-2 hover:bg-gray-100 flex items-center gap-2 cursor-pointer">
              <FiUser /> Profile
            </Link>
